  ...
  return (
    <div className="flex flex-col pt-16">
      ...
      <footer className="border-t bg-gray-50 py-12 text-center text-sm text-muted-foreground">
        © {new Date().getFullYear()} Viqo. All rights reserved. Created by <Link href="https://talhashams.vercel.app" target="_blank"><span className="gradient-title">Agilex Developers</span> </Link>
      </footer>
    </div>
  );
}
