...
export const TESTIMONIALS = [
  {
    quote:
      "Ye Ahmed ka style hai! With Viqo, I finally stopped getting confused about who paid for what!",
    name: "Ahmed",
    image: "/testimonials/babuhaiya.png",
    role: "Rental Property Manager",
  },
  {
    quote:
      "Viqo's calculations are so accurate, they're even better than my scheme to double money in 25 days!",
    name: "Ali",
    image: "/testimonials/rju.jpg",
    role: "Stock Market Expert",
  },
  {
    quote:
      "If that I have Viqo, Ali wont get away with selling my shoes and coat! I'll add to his debt!",
    name: "Ch. Anwar ",
    image: "/testimonials/sham.png",
    role: "Job Searcher",
  },
];
